...
$search=" where idfacture_client = '".$_REQUEST['id']."'";
...
// Requ�te
$query = "UPDATE facture_client set cle='". $s_cle."',
date_creation='". $s_date_creation."',
montant_ht='". $s_montant_ht."',
clt_reference='". $s_clt_reference."',
...
type='". $s_type."',
acc_civilite='". $s_acc_civilite."',
acc_nb_personne='". $s_acc_nb_personne."',
projet='". $s_projet."',
date1='". $s_date1."',
date_modification='". $s_date_modification."',
acc_date_depart='". $s_acc_date_depart."',
montant_ttc='". $s_montant_ttc."',
acc_nom='". $s_acc_nom."',
modification_par='". $s_modification_par."',
pays_projet='". $s_pays_projet."',
contact='". $s_contact."',
acc_date_retour='". $s_acc_date_retour."',
pj1='". $s_pj1."',
acc_facturation_adresse1='". $s_acc_facturation_adresse1."',
cas='". $s_cas."',
heure_modification='". $s_heure_modification."',
facturation_adresse1='". $s_facturation_adresse1."',
operation='". $s_operation."',
utilisateur='". $s_utilisateur."',
facturation_adresse2='". $s_facturation_adresse2."',
note='". $s_note."',
annee='". $s_annee."',
facturation_cp='". $s_facturation_cp."',
acc_facturation_cp='". $s_acc_facturation_cp."',
acc_note='". $s_acc_note."',
date_facture='". $s_date_facture."',
acompte2='". $s_acompte2."',
facturation_ville='". $s_facturation_ville."',
acc_facturation_ville='". $s_acc_facturation_ville."',
date2='". $s_date2."',
numero='". $s_numero."',
pays='". $s_pays."',
acc_hop='". $s_acc_hop."',
pj2='". $s_pj2."',
libelle='". $s_libelle."',
acc_service_hop='". $s_acc_service_hop."',
acompte3='". $s_acompte3."',
date3='". $s_date3."',
pj3='". $s_pj3."',
acompte_total='". $s_acompte_total."',
montant_restant='". $s_montant_restant."',
reglee='". $s_reglee."',
statut='". $s_statut."',
delai_paiement='". $s_delai_paiement."',
pj='". $s_pj."',
montant_total_paiement_ttc='". $s_montant_total_paiement_ttc."',
tva='". $s_tva."',
acompte_regle='". $s_acompte_regle."',
pourcentage1='". $s_pourcentage1."',
acompte_clt_1='". $s_acompte_clt_1."',
acompte_date1='". $s_acompte_date1."',
pourcentage2='". $s_pourcentage2."',
acompte_clt_2='". $s_acompte_clt_2."',
acompte_date2='". $s_acompte_date2."',
statut_compta='". $s_statut_compta."',
statut_compta_paiement='". $s_statut_compta_paiement."',
statut_compta_paiement2='". $s_statut_compta_paiement2."',
statut_compta_paiement3='". $s_statut_compta_paiement3."',
banque='". $s_banque."',
compte_produit='". $s_compte_produit."',
