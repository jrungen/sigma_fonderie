<?php
$synclog = 0;
$search=" where idsatisfaction = '".$_REQUEST['id']."'";
$user = $_REQUEST['user'];
...
if ($_REQUEST['ca_ht']=='') $s_ca_ht = '0'; else $s_ca_ht= str_replace(" ", "", $_REQUEST['ca_ht']);
...
// Requête
$query = "UPDATE satisfaction set cle='". $s_cle."',
...
ca_ht='". $s_ca_ht."',
eval_preparation='". $s_eval_preparation."',
date_preparation='". $s_date_preparation."',
eval_realisation='". $s_eval_realisation."',
liste_preparation='". $s_liste_preparation."',
date_realisation='". $s_date_realisation."',
liste_realisation='". $s_liste_realisation."',
note_preparation='". $s_note_preparation."',
note_realisation='". $s_note_realisation."' $search";
