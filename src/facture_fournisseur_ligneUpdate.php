...
$search=" where idfacture_fournisseur_ligne = '".$_REQUEST['id']."'";
...
// Requête
$query = "UPDATE facture_fournisseur_ligne set facture_fournisseur='". $s_facture_fournisseur."',
cle='". $s_cle."',
type_depenses='". $s_type_depenses."',
acompte_reglement='". $s_acompte_reglement."',
acompte_reglement_ht='". $s_acompte_reglement_ht."',
...
pj_reglement='". $s_pj_reglement."',
date_modification='". $s_date_modification."',
modification_par='". $s_modification_par."',
devise='". $s_devise."',
cas='". $s_cas."',
type_reglement='". $s_type_reglement."',
heure_modification='". $s_heure_modification."',
autre_devise='". $s_autre_devise."',
annee='". $s_annee."',
montant_devise='". $s_montant_devise."',
autres='". $s_autres."',
note='". $s_note."',
beneficiaire='". $s_beneficiaire."',
nom_banque='". $s_nom_banque."',
domiciliation='". $s_domiciliation."',
acompte_paye='". $s_acompte_paye."',
code_banque='". $s_code_banque."',
date_paye='". $s_date_paye."',
code_guichet='". $s_code_guichet."',
pj_paye='". $s_pj_paye."',
num_compte='". $s_num_compte."',
num_cheque='". $s_num_cheque."',
cle_banque='". $s_cle_banque."',
iban='". $s_iban."',
code_swift='". $s_code_swift."',
statut_compta='". $s_statut_compta."',
banque='". $s_banque."',
statut='". $s_statut."' $search";
