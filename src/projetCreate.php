...
if ($_REQUEST['comptable']=='') $s_comptable = ''; else $s_comptable= addslashes($_REQUEST['comptable']);
...
// Requete
$query = "INSERT INTO projet (societe, 
type, 
cle, 
date_creation, 
lieu, 
apporteur_affaire, 
ta_montant_recette_ttc, 
pe_montant_recette_ht, 
nom, 
creation_par, 
datedebut, 
pe_montant_depense_ht, 
ta_montant_recette_accompagnant, 
heure_creation, 
datefin, 
date_modification, 
numero, 
ta_marge_ht, 
pe_marge_ht, 
ta_montant_recette_total_ttc, 
modification_par, 
ta_montant_depense_ttc, 
cas, 
numero_code, 
heure_modification, 
utilisateur, 
...
pays, 
ta_tva_marge, 
ps_montant_recette_ht, 
ca_ht, 
recette2_previsionnelle, 
total_marge, 
recette1_previsionnelle, 
ps_montant_depense_ht, 
depense2_previsionnelle, 
taux_marge, 
ps_marge_ht, 
depense1_previsionnelle, 
marge2_previsionnelle, 
ps_tva_marge, 
montant_total_tva_locale, 
marge1_previsionnelle, 
date1_previsionnelle, 
pj1_previsionnelle, 
date2_previsionnelle, 
pj3_previsionnelle, 
pj2_previsionnelle, 
str_tourisme_affaire, 
std_tourisme_affaire, 
date3_previsionnelle, 
str_presta_evenement, 
std_presta_evenement, 
pj_confirmee, 
pays_client, 
str_total, 
std_total, 
...
nb_reunion_prev, 
nb_reunion_confirme, 
ta_soustotal_autres_facturation, comptable, libelle, nouveau, departement) values('".$s_societe."', 
'".$s_type."', 
'".$s_cle."', 
'".$s_date_creation."', 
'".$s_lieu."',  
'".$s_apporteur_affaire."', 
'".$s_ta_montant_recette_ttc."', 
'".$s_pe_montant_recette_ht."', 
'".$s_nom."', 
'".$s_creation_par."', 
'".$s_datedebut."', 
'".$s_pe_montant_depense_ht."', 
'".$s_ta_montant_recette_accompagnant."', 
'".$s_heure_creation."', 
'".$s_datefin."', 
'".$s_date_modification."', 
'".$s_numero."', 
'".$s_ta_marge_ht."', 
'".$s_pe_marge_ht."', 
'".$s_ta_montant_recette_total_ttc."', 
'".$s_modification_par."', 
'".$s_ta_montant_depense_ttc."', 
'".$s_cas."', 
'".$s_numero_code."', 
...
'".$s_pays."', 
'".$s_ta_tva_marge."', 
'".$s_ps_montant_recette_ht."', 
'".$s_ca_ht."', 
'".$s_recette2_previsionnelle."', 
'".$s_total_marge."', 
'".$s_recette1_previsionnelle."', 
'".$s_ps_montant_depense_ht."', 
'".$s_depense2_previsionnelle."', 
'".$s_taux_marge."', 
'".$s_ps_marge_ht."', 
'".$s_depense1_previsionnelle."', 
'".$s_marge2_previsionnelle."', 
'".$s_ps_tva_marge."', 
'".$s_montant_total_tva_locale."', 
'".$s_marge1_previsionnelle."', 
'".$s_date1_previsionnelle."', 
'".$s_pj1_previsionnelle."', 
'".$s_date2_previsionnelle."', 
'".$s_pj3_previsionnelle."', 
'".$s_pj2_previsionnelle."', 
'".$s_str_tourisme_affaire."', 
'".$s_std_tourisme_affaire."', 
'".$s_date3_previsionnelle."', 
'".$s_str_presta_evenement."', 
'".$s_std_presta_evenement."', 
'".$s_pj_confirmee."', 
'".$s_pays_client."', 
'".$s_str_total."', 
'".$s_std_total."', 
'".$s_st_total_balance."', 
'".$s_nb_reunion_prev."', 
'".$s_nb_reunion_confirme."', 
'".$s_ta_soustotal_autres_facturation."',
'".$s_comptable."',
'".$s_libelle."',
'".$s_nouveau."',
'".$s_departement."')";
