...
// Requête
$query = "SELECT * from facture_fournisseur where 1 AND projet='".$_REQUEST['cle']."' AND type='Factures fournisseurs' AND objet ='Prestation de services' order by societe";
