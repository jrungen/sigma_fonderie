...
// Requete
$query = "INSERT INTO facture_fournisseur (date_facture, 
action, 
cle, 
fourniseur, 
date_creation, 
...
montant_tva_locale, 
montant_ht_locale, 
montant_tva_locale_reduit, 
montant_ht_locale_reduit, 
numero, 
pj, 
montant_ht_0, 
total_acompte, 
...
Remise, 
frais_port, 
tva_s_commission_locale, 
ttc_commission, 
montant_ttc, 
facture_regle, 
total_regle, 
montant_restant_du_facturation, 
validation, 
note_comptable,
montant_ht_7,
montant_tva_7,
...
'".$s_montant_tva_55."', 
'".$s_montant_ht_55."', 
'".$s_montant_tva_locale."', 
'".$s_montant_ht_locale."', 
'".$s_montant_tva_locale_reduit."', 
'".$s_montant_ht_locale_reduit."', 
'".$s_numero."', 
'".$s_pj."', 
'".$s_montant_ht_0."', 
'".$s_total_acompte."', 
...
'".$s_tva_s_commission."', 
'".$s_montant_tva."', 
'".$s_tva_s_commission_55."', 
'".$s_Remise."', 
'".$s_frais_port."', 
'".$s_tva_s_commission_locale."', 
'".$s_ttc_commission."', 
'".$s_montant_ttc."', 
'".$s_facture_regle."', 
'".$s_total_regle."', 
'".$s_montant_restant_du_facturation."', 
'".$s_validation."', 
'".$s_note_comptable."',
'".$s_montant_ht_7."',
'".$s_montant_tva_7."',
